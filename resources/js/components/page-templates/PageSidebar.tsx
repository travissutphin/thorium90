...
import { Calendar, User, Clock, Eye, Tag, FileText } from 'lucide-react';
...
export function PageSidebar({
    ...
    if (customContent) {
        return <div className="space-y-6">{customContent}</div>;
    }

    // Landing page template - minimal sidebar
    if (template === 'landing') {
        return (
    ...
    // Full-width template - no sidebar content
