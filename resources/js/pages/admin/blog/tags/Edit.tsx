...
import { ArrowLeft, Save, Trash2, Tag as TagIcon, Hash } from 'lucide-react';
...
export default function EditBlogTag({ tag }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await router.put(`/admin/blog/tags/${tag.id}`, formData);
        } catch (error: any) {
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Modify tag settings and appearance
                            </p>
                        </div>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm">{formatDate(tag.created_at)}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-sm text-gray-600 dark:text-gray-400">Updated:</span>
                                    <span className="text-sm">{formatDate(tag.updated_at)}</span>
                                </div>
                                {tag.usage_count > 0 && (
                                    <div className="pt-2 border-t">
                                        <p className="text-xs text-blue-600 dark:text-blue-400">
                                            This tag is used by {tag.usage_count} post{tag.usage_count > 1 ? 's' : ''}. Deleting it will remove it from all posts.
                                        </p>
                                    </div>
                                )}
                            </CardContent>
